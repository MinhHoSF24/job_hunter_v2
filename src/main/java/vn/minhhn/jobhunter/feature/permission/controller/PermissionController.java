package vn.minhhn.jobhunter.feature.permission.controller;
...
import vn.minhhn.jobhunter.feature.permission.service.PermissionService;
...
public class PermissionController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<PermissionResponse>> getById(@PathVariable("id") Long id) {
